...
if (!defined("PHPUnit2_MAIN_METHOD")) {
    define("PHPUnit2_MAIN_METHOD", "GtkRulerTest::main");
}
 ...
 */
class GtkRulerTest extends PHPUnit2_Framework_TestCase {
    /**
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit2_Framework_TestSuite("GtkRulerTest");
...
// Call GtkRulerTest::main() if this source file is executed directly.
if (PHPUnit2_MAIN_METHOD == "GtkRulerTest::main") {
    GtkRulerTest::main();
}
?>
