...
if (!defined("PHPUnit_MAIN_METHOD")) {
    define("PHPUnit_MAIN_METHOD", "GtkImageMenuItemTest::main");
}
 ...
 */
class GtkImageMenuItemTest extends PHPUnit_Framework_TestCase {
    /**
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit_Framework_TestSuite("GtkImageMenuItemTest");
...
// Call GtkImageMenuItemTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == "GtkImageMenuItemTest::main") {
