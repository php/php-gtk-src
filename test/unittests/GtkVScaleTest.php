...
if (!defined("PHPUnit2_MAIN_METHOD")) {
    define("PHPUnit2_MAIN_METHOD", "GtkVScaleTest::main");
}
 ...
 */
class GtkVScaleTest extends PHPUnit2_Framework_TestCase {
    /**
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit2_Framework_TestSuite("GtkVScaleTest");
...
// Call GtkVScaleTest::main() if this source file is executed directly.
if (PHPUnit2_MAIN_METHOD == "GtkVScaleTest::main") {
    GtkVScaleTest::main();
}
?>
