...
if (!defined("PHPUnit2_MAIN_METHOD")) {
    define("PHPUnit2_MAIN_METHOD", "GdkDeviceTest::main");
}
 ...
 */
class GdkDeviceTest extends PHPUnit2_Framework_TestCase {
    /**
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit2_Framework_TestSuite("GdkDeviceTest");
...
// Call GdkDeviceTest::main() if this source file is executed directly.
if (PHPUnit2_MAIN_METHOD == "GdkDeviceTest::main") {
    GdkDeviceTest::main();
}
?>
