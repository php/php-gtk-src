...
if (!defined("PHPUnit2_MAIN_METHOD")) {
    define("PHPUnit2_MAIN_METHOD", "GtkRequisitionTest::main");
}
 ...
 */
class GtkRequisitionTest extends PHPUnit2_Framework_TestCase {
    /**
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit2_Framework_TestSuite("GtkRequisitionTest");
...
// Call GtkRequisitionTest::main() if this source file is executed directly.
if (PHPUnit2_MAIN_METHOD == "GtkRequisitionTest::main") {
