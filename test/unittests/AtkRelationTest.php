...
if (!defined("PHPUnit2_MAIN_METHOD")) {
    define("PHPUnit2_MAIN_METHOD", "AtkRelationTest::main");
}
 ...
 */
class AtkRelationTest extends PHPUnit2_Framework_TestCase {
    /**
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit2_Framework_TestSuite("AtkRelationTest");
...
// Call AtkRelationTest::main() if this source file is executed directly.
if (PHPUnit2_MAIN_METHOD == "AtkRelationTest::main") {
