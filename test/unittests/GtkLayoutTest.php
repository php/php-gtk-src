...
if (!defined("PHPUnit2_MAIN_METHOD")) {
    define("PHPUnit2_MAIN_METHOD", "GtkLayoutTest::main");
}
 ...
 */
class GtkLayoutTest extends PHPUnit2_Framework_TestCase {
    /**
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit2_Framework_TestSuite("GtkLayoutTest");
...
// Call GtkLayoutTest::main() if this source file is executed directly.
if (PHPUnit2_MAIN_METHOD == "GtkLayoutTest::main") {
    GtkLayoutTest::main();
}
?>
