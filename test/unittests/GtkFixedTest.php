...
if (!defined("PHPUnit_MAIN_METHOD")) {
    define("PHPUnit_MAIN_METHOD", "GtkFixedTest::main");
}
 ...
 */
class GtkFixedTest extends PHPUnit_Framework_TestCase {
    /**
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit_Framework_TestSuite("GtkFixedTest");
...
// Call GtkFixedTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == "GtkFixedTest::main") {
    GtkFixedTest::main();
}
?>
