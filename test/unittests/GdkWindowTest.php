...
if (!defined("PHPUnit2_MAIN_METHOD")) {
    define("PHPUnit2_MAIN_METHOD", "GdkWindowTest::main");
}
 ...
 */
class GdkWindowTest extends PHPUnit2_Framework_TestCase {
    /**
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit2_Framework_TestSuite("GdkWindowTest");
...
// Call GdkWindowTest::main() if this source file is executed directly.
if (PHPUnit2_MAIN_METHOD == "GdkWindowTest::main") {
    GdkWindowTest::main();
}
?>
