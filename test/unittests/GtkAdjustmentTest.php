...
if (!defined("PHPUnit_MAIN_METHOD")) {
    define("PHPUnit_MAIN_METHOD", "GtkAdjustmentTest::main");
}
 ...
 */
class GtkAdjustmentTest extends PHPUnit_Framework_TestCase {
    /**
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit_Framework_TestSuite("GtkAdjustmentTest");
    ...
    /**
     * @todo Implement testSet_all().
     */
    public function testSet_all() {
        // Remove the following line when you implement this test.
        $this->markTestIncomplete(
          "This test has not been implemented yet."
        );
...
// Call GtkAdjustmentTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == "GtkAdjustmentTest::main") {
