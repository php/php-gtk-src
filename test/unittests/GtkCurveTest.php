...
if (!defined("PHPUnit_MAIN_METHOD")) {
    define("PHPUnit_MAIN_METHOD", "GtkCurveTest::main");
}
 ...
 */
class GtkCurveTest extends PHPUnit_Framework_TestCase {
    /**
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit_Framework_TestSuite("GtkCurveTest");
    ...
    /**
     * @todo Implement testGet_vector().
     */
    public function testGet_vector() {
    ...
    /**
     * @todo Implement testSet_vector().
     */
    public function testSet_vector() {
        // Remove the following line when you implement this test.
        $this->markTestIncomplete(
          "This test has not been implemented yet."
        );
...
// Call GtkCurveTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == "GtkCurveTest::main") {
    GtkCurveTest::main();
}
?>
