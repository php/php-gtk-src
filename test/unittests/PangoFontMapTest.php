...
if (!defined("PHPUnit2_MAIN_METHOD")) {
    define("PHPUnit2_MAIN_METHOD", "PangoFontMapTest::main");
}
 ...
 */
class PangoFontMapTest extends PHPUnit2_Framework_TestCase {
    /**
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit2_Framework_TestSuite("PangoFontMapTest");
...
// Call PangoFontMapTest::main() if this source file is executed directly.
if (PHPUnit2_MAIN_METHOD == "PangoFontMapTest::main") {
