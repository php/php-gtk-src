...
if (!defined("PHPUnit2_MAIN_METHOD")) {
    define("PHPUnit2_MAIN_METHOD", "AtkTest::main");
}
 ...
 */
class AtkTest extends PHPUnit2_Framework_TestCase {
    /**
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit2_Framework_TestSuite("AtkTest");
...
// Call AtkTest::main() if this source file is executed directly.
if (PHPUnit2_MAIN_METHOD == "AtkTest::main") {
    AtkTest::main();
}
?>
