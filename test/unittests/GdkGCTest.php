...
if (!defined("PHPUnit2_MAIN_METHOD")) {
    define("PHPUnit2_MAIN_METHOD", "GdkGCTest::main");
}
 ...
 */
class GdkGCTest extends PHPUnit2_Framework_TestCase {
    /**
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit2_Framework_TestSuite("GdkGCTest");
...
// Call GdkGCTest::main() if this source file is executed directly.
if (PHPUnit2_MAIN_METHOD == "GdkGCTest::main") {
    GdkGCTest::main();
}
?>
