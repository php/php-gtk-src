...
if (!defined("PHPUnit2_MAIN_METHOD")) {
    define("PHPUnit2_MAIN_METHOD", "GtkFrameTest::main");
}
 ...
 */
class GtkFrameTest extends PHPUnit2_Framework_TestCase {
    /**
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit2_Framework_TestSuite("GtkFrameTest");
...
// Call GtkFrameTest::main() if this source file is executed directly.
if (PHPUnit2_MAIN_METHOD == "GtkFrameTest::main") {
    GtkFrameTest::main();
}
?>
