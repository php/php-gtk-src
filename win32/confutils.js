...
/* PHP-GTK default; see get_version_numbers() */
var PHP_GTK_VERSION = "2.0.0";
var PHP_GTK_VERSION_STRING = "2.0.0";
...
function get_version_numbers() {
	...
	/* pick up the precise version from main/php_gtk.h */
	var phpgtkh = file_get_contents("main/php_gtk.h");

	if (phpgtkh.match(new RegExp("PHP_GTK_VERSION=\"([^\"]+)\""))) {
		PHP_GTK_VERSION = RegExp.$1;
		PHP_GTK_VERSION_STRING = PHP_GTK_VERSION;
	}
	DEFINE('PHP_GTK_VERSION_STRING', PHP_GTK_VERSION_STRING);
}
