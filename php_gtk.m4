...
PHP_NEW_EXTENSION(php_gtk, main/php_gtk.c main/phpg_gtype.c main/phpg_exceptions.c main/php_gtk_util.c main/phpg_gvalue.c main/phpg_gboxed.c main/phpg_gobject.c, $ext_shared,, -I@ext_srcdir@/main)
