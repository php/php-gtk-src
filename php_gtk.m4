...
PHP_NEW_EXTENSION(php_gtk, main/php_gtk.c main/php_gtk_object.c main/php_gtype.c main/phpg_exceptions.c main/php_gtk_util.c, $ext_shared,, -I@ext_srcdir@/main)
