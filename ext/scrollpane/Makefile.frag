...
$(srcdir)/gen_scrollpane.c: $(srcdir)/scrollpane.defs $(srcdir)/scrollpane.overrides
	$(PHP) -f $(top_srcdir)/generator/generator.php -- -o $(srcdir)/scrollpane.overrides -p Scrollpane -r $(top_srcdir)/ext/gtk%2b/gtk.defs $(srcdir)/scrollpane.defs > $(srcdir)/gen_scrollpane.c
