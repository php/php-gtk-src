...
$(srcdir)/gen_gtkhtml.c: $(srcdir)/gtkhtml.defs $(srcdir)/gtkhtml.overrides
	$(PHP) -f $(top_srcdir)/generator/generator.php -- -o $(srcdir)/gtkhtml.overrides -p gtkhtml -r $(top_srcdir)/ext/gtk%2b/gtk.defs $(srcdir)/gtkhtml.defs > $(srcdir)/gen_gtkhtml.c
