...
void php_gdk_register_keysyms(int module_number TSRMLS_DC)
{
	...
	REGISTER_LONG_CONSTANT("_GDK_KEY_a", GDK_a, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_b", GDK_b, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_c", GDK_c, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_d", GDK_d, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_e", GDK_e, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_f", GDK_f, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_g", GDK_g, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_h", GDK_h, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_i", GDK_i, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_j", GDK_j, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_k", GDK_k, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_l", GDK_l, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_m", GDK_m, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_n", GDK_n, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_o", GDK_o, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_p", GDK_p, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_q", GDK_q, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_r", GDK_r, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_s", GDK_s, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_t", GDK_t, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_u", GDK_u, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_v", GDK_v, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_w", GDK_w, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_x", GDK_x, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_y", GDK_y, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_z", GDK_z, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("_GDK_KEY_Eth", GDK_Eth, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("_GDK_KEY_Thorn", GDK_Thorn, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("GDK_KEY_ssharp", GDK_ssharp, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_agrave", GDK_agrave, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_aacute", GDK_aacute, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_acircumflex", GDK_acircumflex, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_atilde", GDK_atilde, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_adiaeresis", GDK_adiaeresis, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_aring", GDK_aring, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_ae", GDK_ae, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_ccedilla", GDK_ccedilla, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_egrave", GDK_egrave, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_eacute", GDK_eacute, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_ecircumflex", GDK_ecircumflex, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_ediaeresis", GDK_ediaeresis, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_igrave", GDK_igrave, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_iacute", GDK_iacute, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_icircumflex", GDK_icircumflex, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_idiaeresis", GDK_idiaeresis, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("__GDK_KEY_eth", GDK_eth, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_ntilde", GDK_ntilde, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_ograve", GDK_ograve, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_oacute", GDK_oacute, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_ocircumflex", GDK_ocircumflex, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_otilde", GDK_otilde, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_odiaeresis", GDK_odiaeresis, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("_GDK_KEY_ugrave", GDK_ugrave, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_uacute", GDK_uacute, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_ucircumflex", GDK_ucircumflex, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_udiaeresis", GDK_udiaeresis, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_yacute", GDK_yacute, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("__GDK_KEY_thorn", GDK_thorn, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("_GDK_KEY_aogonek", GDK_aogonek, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("GDK_KEY_ogonek", GDK_ogonek, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_lstroke", GDK_lstroke, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_lcaron", GDK_lcaron, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_sacute", GDK_sacute, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("GDK_KEY_caron", GDK_caron, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_scaron", GDK_scaron, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_scedilla", GDK_scedilla, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_tcaron", GDK_tcaron, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_zacute", GDK_zacute, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("GDK_KEY_doubleacute", GDK_doubleacute, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_zcaron", GDK_zcaron, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_zabovedot", GDK_zabovedot, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("_GDK_KEY_racute", GDK_racute, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_abreve", GDK_abreve, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_lacute", GDK_lacute, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_cacute", GDK_cacute, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_ccaron", GDK_ccaron, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_eogonek", GDK_eogonek, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_ecaron", GDK_ecaron, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_dcaron", GDK_dcaron, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_dstroke", GDK_dstroke, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_nacute", GDK_nacute, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_ncaron", GDK_ncaron, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_odoubleacute", GDK_odoubleacute, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_udoubleacute", GDK_udoubleacute, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_rcaron", GDK_rcaron, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_uring", GDK_uring, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_tcedilla", GDK_tcedilla, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("_GDK_KEY_hstroke", GDK_hstroke, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_hcircumflex", GDK_hcircumflex, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("GDK_KEY_idotless", GDK_idotless, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_gbreve", GDK_gbreve, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_jcircumflex", GDK_jcircumflex, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("_GDK_KEY_cabovedot", GDK_cabovedot, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_ccircumflex", GDK_ccircumflex, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_gabovedot", GDK_gabovedot, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_gcircumflex", GDK_gcircumflex, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_ubreve", GDK_ubreve, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_scircumflex", GDK_scircumflex, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("_GDK_KEY_rcedilla", GDK_rcedilla, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_itilde", GDK_itilde, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_lcedilla", GDK_lcedilla, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_emacron", GDK_emacron, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_gcedilla", GDK_gcedilla, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_tslash", GDK_tslash, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("GDK_KEY_ENG", GDK_ENG, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_eng", GDK_eng, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("_GDK_KEY_amacron", GDK_amacron, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_iogonek", GDK_iogonek, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_eabovedot", GDK_eabovedot, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_imacron", GDK_imacron, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_ncedilla", GDK_ncedilla, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_omacron", GDK_omacron, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_kcedilla", GDK_kcedilla, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_uogonek", GDK_uogonek, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_utilde", GDK_utilde, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_umacron", GDK_umacron, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("_GDK_KEY_kana_A", GDK_kana_A, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_kana_I", GDK_kana_I, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_kana_U", GDK_kana_U, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_kana_E", GDK_kana_E, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_kana_O", GDK_kana_O, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("_GDK_KEY_kana_TSU", GDK_kana_TSU, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_kana_TU", GDK_kana_TU, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("_GDK_KEY_kana_YA", GDK_kana_YA, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_kana_YU", GDK_kana_YU, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_kana_YO", GDK_kana_YO, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("_GDK_KEY_Serbian_DJE", GDK_Serbian_DJE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Macedonia_GJE", GDK_Macedonia_GJE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_IO", GDK_Cyrillic_IO, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Ukrainian_IE", GDK_Ukrainian_IE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Ukranian_JE", GDK_Ukranian_JE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Macedonia_DSE", GDK_Macedonia_DSE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Ukrainian_I", GDK_Ukrainian_I, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Ukranian_I", GDK_Ukranian_I, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Ukrainian_YI", GDK_Ukrainian_YI, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Ukranian_YI", GDK_Ukranian_YI, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_JE", GDK_Cyrillic_JE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Serbian_JE", GDK_Serbian_JE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_LJE", GDK_Cyrillic_LJE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Serbian_LJE", GDK_Serbian_LJE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_NJE", GDK_Cyrillic_NJE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Serbian_NJE", GDK_Serbian_NJE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Serbian_TSHE", GDK_Serbian_TSHE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Macedonia_KJE", GDK_Macedonia_KJE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Byelorussian_SHORTU", GDK_Byelorussian_SHORTU, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_DZHE", GDK_Cyrillic_DZHE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Serbian_DZE", GDK_Serbian_DZE, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_YU", GDK_Cyrillic_YU, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_A", GDK_Cyrillic_A, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_BE", GDK_Cyrillic_BE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_TSE", GDK_Cyrillic_TSE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_DE", GDK_Cyrillic_DE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_IE", GDK_Cyrillic_IE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_EF", GDK_Cyrillic_EF, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_GHE", GDK_Cyrillic_GHE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_HA", GDK_Cyrillic_HA, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_I", GDK_Cyrillic_I, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_SHORTI", GDK_Cyrillic_SHORTI, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_KA", GDK_Cyrillic_KA, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_EL", GDK_Cyrillic_EL, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_EM", GDK_Cyrillic_EM, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_EN", GDK_Cyrillic_EN, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_O", GDK_Cyrillic_O, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_PE", GDK_Cyrillic_PE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_YA", GDK_Cyrillic_YA, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_ER", GDK_Cyrillic_ER, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_ES", GDK_Cyrillic_ES, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_TE", GDK_Cyrillic_TE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_U", GDK_Cyrillic_U, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_ZHE", GDK_Cyrillic_ZHE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_VE", GDK_Cyrillic_VE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_SOFTSIGN", GDK_Cyrillic_SOFTSIGN, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_YERU", GDK_Cyrillic_YERU, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_ZE", GDK_Cyrillic_ZE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_SHA", GDK_Cyrillic_SHA, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_E", GDK_Cyrillic_E, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_SHCHA", GDK_Cyrillic_SHCHA, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_CHE", GDK_Cyrillic_CHE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Cyrillic_HARDSIGN", GDK_Cyrillic_HARDSIGN, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_alphaaccent", GDK_Greek_alphaaccent, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_epsilonaccent", GDK_Greek_epsilonaccent, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_etaaccent", GDK_Greek_etaaccent, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_iotaaccent", GDK_Greek_iotaaccent, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_omicronaccent", GDK_Greek_omicronaccent, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_upsilonaccent", GDK_Greek_upsilonaccent, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_upsilondieresis", GDK_Greek_upsilondieresis, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("GDK_KEY_Greek_upsilonaccentdieresis", GDK_Greek_upsilonaccentdieresis, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_omegaaccent", GDK_Greek_omegaaccent, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_alpha", GDK_Greek_alpha, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_beta", GDK_Greek_beta, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_gamma", GDK_Greek_gamma, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_delta", GDK_Greek_delta, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_epsilon", GDK_Greek_epsilon, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_zeta", GDK_Greek_zeta, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_eta", GDK_Greek_eta, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_theta", GDK_Greek_theta, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_iota", GDK_Greek_iota, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_kappa", GDK_Greek_kappa, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_lamda", GDK_Greek_lamda, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_lambda", GDK_Greek_lambda, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_mu", GDK_Greek_mu, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_nu", GDK_Greek_nu, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_xi", GDK_Greek_xi, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_omicron", GDK_Greek_omicron, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_pi", GDK_Greek_pi, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_rho", GDK_Greek_rho, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_sigma", GDK_Greek_sigma, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("GDK_KEY_Greek_finalsmallsigma", GDK_Greek_finalsmallsigma, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_tau", GDK_Greek_tau, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_upsilon", GDK_Greek_upsilon, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_phi", GDK_Greek_phi, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_chi", GDK_Greek_chi, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_psi", GDK_Greek_psi, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("_GDK_KEY_Greek_omega", GDK_Greek_omega, CONST_CS | CONST_PERSISTENT);
