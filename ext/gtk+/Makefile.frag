...
$(srcdir)/gen_gtk.c: $(srcdir)/gtk.defs $(srcdir)/gtk-extrafuncs.defs $(srcdir)/gtk.overrides
	$(PHP) -q $(top_srcdir)/generator/generator.php -o ext/gtk%2b/gtk.overrides -p Gtk -r $(top_srcdir)/ext/gtk%2b/gdk.defs ext/gtk%2b/gtk.defs > $(srcdir)/gen_gtk.c

$(srcdir)/gen_gdk.c: $(srcdir)/gdk.defs $(srcdir)/gdk.overrides
	$(PHP) -q $(top_srcdir)/generator/generator.php -o ext/gtk%2b/gdk.overrides -p Gdk ext/gtk%2b/gdk.defs > $(srcdir)/gen_gdk.c
