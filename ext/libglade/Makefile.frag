...
$(srcdir)/gen_libglade.c: $(srcdir)/libglade.defs $(srcdir)/libglade.overrides
	$(PHP) -f $(top_srcdir)/generator/generator.php -- -o $(srcdir)/libglade.overrides -p libglade -r $(top_srcdir)/ext/gtk%2b/gtk.defs $(srcdir)/libglade.defs > $(srcdir)/gen_libglade.c
