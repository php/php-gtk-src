...
$(srcdir)/gen_combobutton.c: $(srcdir)/combobutton.defs $(srcdir)/combobutton.overrides
	$(PHP) -q $(top_srcdir)/generator/generator.php -o $(srcdir)/combobutton.overrides -p ComboButton -r $(top_srcdir)/ext/gtk%2b/gtk.defs $(srcdir)/combobutton.defs > $(srcdir)/gen_combobutton.c
