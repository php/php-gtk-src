...
$(srcdir)/gen_piemenu.c: $(srcdir)/piemenu.defs $(srcdir)/piemenu.overrides
	$(PHP) -q $(top_srcdir)/generator/generator.php -o $(srcdir)/piemenu.overrides -p PieMenu -r $(top_srcdir)/ext/gtk%2b/gtk.defs $(srcdir)/piemenu.defs > $(srcdir)/gen_piemenu.c
