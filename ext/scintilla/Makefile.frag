...
$(srcdir)/gen_scintilla.c: $(srcdir)/scintilla.defs $(srcdir)/scintilla.overrides
	$(PHP) -f $(top_srcdir)/generator/generator.php -- -o $(srcdir)/scintilla.overrides -p Scintilla -r $(top_srcdir)/ext/gtk%2b/gtk.defs $(srcdir)/scintilla.defs > $(srcdir)/gen_scintilla.c
